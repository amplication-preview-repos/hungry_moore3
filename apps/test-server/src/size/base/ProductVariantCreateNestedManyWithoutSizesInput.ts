...
@InputType()
class ProductVariantCreateNestedManyWithoutSizesInput {
...
export { ProductVariantCreateNestedManyWithoutSizesInput as ProductVariantCreateNestedManyWithoutSizesInput };
