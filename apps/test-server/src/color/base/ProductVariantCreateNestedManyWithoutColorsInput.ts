...
@InputType()
class ProductVariantCreateNestedManyWithoutColorsInput {
...
export { ProductVariantCreateNestedManyWithoutColorsInput as ProductVariantCreateNestedManyWithoutColorsInput };
